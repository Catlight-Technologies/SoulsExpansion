    ...
    public class MarstechEnchant : BaseEnchant
    {
        ...
        public class MarstechEffect : AccessoryEffect
        {
            ...
            public override void PostUpdateEquips(Player player)
            {
                ...
                CooldownBarManager.Activate("MarstechEnchantCooldown", ModContent.Request<Texture2D>("CSE/Assets/Textures/Content/Items/Accessories/Enchantments/MarstechEnchant").Value, new(61, 155, 189),
