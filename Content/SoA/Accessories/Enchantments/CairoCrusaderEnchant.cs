...
namespace CSE.Content.SoA.Accessories.Enchantments
{
    ...
    public class CairoCrusaderEnchant : BaseEnchant
    {
        ...
        public class CairoCrusaderEffect : AccessoryEffect
        {
            ...
            public override void PostUpdateEquips(Player player)
            {
                ...
                {
                    Projectile.NewProjectile(player.GetSource_FromThis("SetBonus_CairoCrusader"), player.Center, Vector2.Zero, ModContent.ProjectileType<EternalOasis>(), (int)player.GetTotalDamage<ThrowingDamageClass>().ApplyTo(player.HasEffect<GenerationsEffect>() ? 500f : 50f), 0f, player.whoAmI);
                }
            }
        }
