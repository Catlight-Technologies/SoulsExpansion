...
namespace CSE.Content.SoA.Projectiles
{
    ...
    public class DreadfireAuraProj : ModProjectile
    {
        ...
        public override bool PreDraw(ref Color lightColor)
        {
            ...
            var diagonalNoise = CSEUtils.LoadDeferred("FargowiltasSouls/Assets/Textures/Noise/CrustyNoise").Value;
            ...
            Main.spriteBatch.GraphicsDevice.Textures[1] = diagonalNoise;
