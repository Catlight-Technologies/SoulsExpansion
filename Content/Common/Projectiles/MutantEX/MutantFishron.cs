    ...
    public class MutantFishron : ModProjectile
    {
        ...
        public override void AI()
        {
            if (Projectile.localAI[1] == 0f)
            {
                ...
                p = Utilities.AnyBosses() ? Main.npc[FargoSoulsGlobalNPC.boss].target : Player.FindClosest(Projectile.Center, 0, 0);
                Projectile.netUpdate = true;
            }

            int dashDelay = (Projectile.ai[2] == 2) ? 85*2 : 85; 

            if (++Projectile.localAI[0] > dashDelay) //dash
            {
            ...
            else //preparing to dash
            {
                ...
                if (Projectile.localAI[0] == dashDelay) //just about to dash
                {
