...
using CSE.Content.Crossmod.CraftingStation;
using CSE.Content.Thorium.CraftingStation;
using CSE.Content.MoR.CraftingStation;

namespace CSE.Content.Common.CraftingStation
{
    public class MutantsForgeItem : ModItem
    {
        ...
        public override void AddRecipes()
        {
            ...
            {
                recipe.AddIngredient<XeniumFabricatorItem>();
            }

            if (ModLoader.HasMod("NoxusBoss"))
            {
                recipe.AddIngredient(ModLoader.GetMod("NoxusBoss").Find<ModItem>("StarlitForge"), 1);
            }
