    ...
    public class BerserkerSoulRecipe : ModSystem
    {
        public override void PostAddRecipes()
        {
            for (int i = 0; i < Recipe.numRecipes; i++)
            {
                ...
                {
                    if (ModCompatibility.SacredTools.Loaded) { recipe.AddIngredient(ModCompatibility.SacredTools.Mod.Find<ModItem>("TrueMoonEdgedPandolarra"), 1); recipe.AddIngredient(ModCompatibility.SacredTools.Mod.Find<ModItem>("SolarSigil"), 1); recipe.RemoveIngredient(ItemID.CelestialShell); recipe.RemoveIngredient(ItemID.WarriorEmblem); }
                    ...
                    if (ModCompatibility.Redemption.Loaded) { recipe.AddIngredient(ModCompatibility.Redemption.Mod.Find<ModItem>("PZGauntlet"), 1); recipe.AddIngredient(ModCompatibility.Redemption.Mod.Find<ModItem>("MutagenMelee"), 1); recipe.RemoveIngredient(ItemID.WarriorEmblem); }
                ...
                if (ModCompatibility.Calamity.Loaded)
                {
                    if (recipe.HasResult(ModCompatibility.Calamity.Mod.Find<ModItem>("ArkoftheCosmos")))
                    {
                        ...
                        if (ModCompatibility.Thorium.Loaded) { recipe.AddIngredient(Mod.Find<ModItem>("DreamEssence"), 1);}
