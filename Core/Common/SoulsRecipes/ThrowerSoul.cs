    ...
    public class ThrowerSoulRecipe : ModSystem
    {
        public override void PostAddRecipes()
        {
            for (int i = 0; i < Recipe.numRecipes; i++)
            {
                ...
                {
                    if (ModCompatibility.SacredTools.Loaded) { recipe.AddIngredient(ModCompatibility.SacredTools.Mod.Find<ModItem>("DreadflameEmblem"), 1); recipe.AddIngredient(ModCompatibility.SacredTools.Mod.Find<ModItem>("QuasarSigil"), 1); recipe.AddIngredient(ModCompatibility.SacredTools.Mod.Find<ModItem>("BlindJustice"), 1); recipe.RemoveIngredient(ModContent.ItemType<RogueEmblem>()); }
                    //if (ModCompatibility.Redemption.Loaded) { recipe.AddIngredient(ModContent.ItemType<MutagenThrowingCal>(), 1); recipe.RemoveIngredient(ModContent.ItemType<RogueEmblem>());}
