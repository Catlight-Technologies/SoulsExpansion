...
namespace CSE.Core.SoulsRecipes
{
    public class ColossusSoulRecipe : ModSystem
    {
        public override void PostAddRecipes()
        {
            for (int i = 0; i < Recipe.numRecipes; i++)
            {
                ...
                {
                    if (ModCompatibility.SacredTools.Loaded && !ModCompatibility.Calamity.Loaded) { /*recipe.AddIngredient(ModCompatibility.SacredTools.Mod.Find<ModItem>("NightmareBlindfold"), 1);*/ recipe.AddIngredient(ModCompatibility.SacredTools.Mod.Find<ModItem>("ReflectionShield"), 1); recipe.RemoveIngredient(ItemID.AnkhShield); }
                    if (ModCompatibility.Homeward.Loaded) { /*recipe.AddIngredient(ModCompatibility.Homeward.Mod.Find<ModItem>("OneGiantLeap"), 1);*/ recipe.AddIngredient(ModCompatibility.Homeward.Mod.Find<ModItem>("MasterShield"), 1); recipe.RemoveIngredient(ItemID.CharmofMyths); recipe.RemoveIngredient(ItemID.AnkhShield); }
                    if (ModCompatibility.Redemption.Loaded) { recipe.AddIngredient(ModCompatibility.Redemption.Mod.Find<ModItem>("PocketShieldGenerator"), 1); recipe.AddIngredient(ModCompatibility.Redemption.Mod.Find<ModItem>("HEVSuit"), 1); } 
                    if (ModCompatibility.Thorium.Loaded) { recipe.AddIngredient(ModCompatibility.Thorium.Mod.Find<ModItem>("BlastShield"), 1); recipe.AddIngredient(ModCompatibility.Thorium.Mod.Find<ModItem>("Phylactery"), 1); recipe.RemoveIngredient(ItemID.AnkhShield); }
                    if (ModCompatibility.Thorium.Loaded && !ModCompatibility.Calamity.Loaded && !ModCompatibility.Homeward.Loaded && !ModCompatibility.SacredTools.Loaded) { recipe.AddIngredient(ModCompatibility.Thorium.Mod.Find<ModItem>("TerrariumDefender"), 1); recipe.RemoveIngredient(ItemID.FrozenShield); recipe.RemoveIngredient(ItemID.AnkhShield); }
                    if (ModCompatibility.Calamity.Loaded) { recipe.AddIngredient(ModCompatibility.Calamity.Mod.Find<ModItem>("RampartofDeities"), 1); recipe.RemoveIngredient(ModContent.ItemType<Devilshield>()); }
                    if (ModCompatibility.Homeward.Loaded && !ModCompatibility.Calamity.Loaded) { recipe.AddIngredient(ModCompatibility.Homeward.Mod.Find<ModItem>("VanguardBreastpiece"), 1); }
                }
                ...
                if (ModCompatibility.Thorium.Loaded)
                {
                    ...
                    {
                        recipe.AddIngredient(Mod.Find<ModItem>("CorruptedWarShield"), 1);
                ...
                if (ModCompatibility.SacredTools.Loaded)
                {
                    if (recipe.HasResult(ModCompatibility.SacredTools.Mod.Find<ModItem>("CelestialShield")))
                    {
                        ...
                        //if (ModCompatibility.Thorium.Loaded && !ModCompatibility.Calamity.Loaded) { recipe.AddIngredient(ModCompatibility.Thorium.Mod.Find<ModItem>("TerrariumDefender"), 1); recipe.RemoveIngredient(ItemID.AnkhShield); }
                    }
                }
                ...
                if (ModCompatibility.Calamity.Loaded)
                {
                    if (recipe.HasResult(ModCompatibility.Calamity.Mod.Find<ModItem>("RampartofDeities")))
                    {
                        ...
                        if (ModCompatibility.SacredTools.Loaded) { recipe.AddIngredient(ModCompatibility.SacredTools.Mod.Find<ModItem>("ReflectionShield"), 1); recipe.RemoveIngredient(ItemID.FrozenShield); }
                    }
                }
            }
        }
    ...
    public class ColossusSoulEffects : GlobalItem
    {
        ...
        public override void ModifyTooltips(Item item, List<TooltipLine> tooltips)
        {
            ...
            if (item.type == ModContent.ItemType<ColossusSoul>() )
            {
                if (ModCompatibility.Redemption.Loaded)
                {
                    ...
                    tooltips.Insert(5, new TooltipLine(Mod, "mayo2", Language.GetTextValue(key + "RedColossus2")));
                }
                if (ModCompatibility.SacredTools.Loaded)
                {
                ...
                if (ModCompatibility.Homeward.Loaded)
                {
                    tooltips.Insert(5, new TooltipLine(Mod, "mayo5", Language.GetTextValue(key + "HWJColossus2")));
                ...
                if (ModCompatibility.Thorium.Loaded)
                {
                    tooltips.Insert(5, new TooltipLine(Mod, "mayo1", Language.GetTextValue(key + "ThoriumColossus1")));
                    tooltips.Insert(5, new TooltipLine(Mod, "mayo2", Language.GetTextValue(key + "ThoriumColossus3")));
                    tooltips.Insert(5, new TooltipLine(Mod, "mayo2", Language.GetTextValue(key + "ThoriumColossus4")));
                }
            }
            if (ModCompatibility.SacredTools.Loaded)
            {
                if ((item.type == ModCompatibility.SacredTools.Mod.Find<ModItem>("CelestialShield").Type
                    || item.type == ModCompatibility.SacredTools.Mod.Find<ModItem>("ReflectionShield").Type) )
                {
                    if (ModCompatibility.Homeward.Loaded)
                    {
            ...
            if (ModCompatibility.Thorium.Loaded)
            {
                if (item.type == ModCompatibility.Thorium.Mod.Find<ModItem>("TerrariumDefender").Type)
                {
                    tooltips.Insert(5, new TooltipLine(Mod, "mayo3", Language.GetTextValue(key + "ThoriumColossus4")));
                }
            }
            if (ModCompatibility.Homeward.Loaded)
            {
        ...
        public class RampartEffect : AccessoryEffect
        {
            public override Header ToggleHeader => Header.GetHeader<ColossusHeader>();
            ...
            public override void PostUpdateEquips(Player player)
            {
                ModCompatibility.Calamity.Mod.Find<ModItem>("RampartofDeities").UpdateAccessory(player, true);
            }
        }
        ...
        {
            public override Header ToggleHeader => Header.GetHeader<ColossusHeader>();
            public override int ToggleItemType => ModContent.ItemType<PocketShieldGenerator>();
        ...
        {
            public override Header ToggleHeader => Header.GetHeader<ColossusHeader>();
            public override int ToggleItemType => ModContent.ItemType<Phylactery>();
