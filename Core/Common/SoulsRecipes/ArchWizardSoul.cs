    ...
    public class ArchWizardSoulRecipe : ModSystem
    {
        public override void PostAddRecipes()
        {
            for (int i = 0; i < Recipe.numRecipes; i++)
            {
                ...
                {
                    if (ModCompatibility.Homeward.Loaded && !ModCompatibility.Calamity.Loaded) { recipe.AddIngredient(ModCompatibility.Homeward.Mod.Find<ModItem>("EruditeBookmark"), 1); }

                    if (ModCompatibility.SacredTools.Loaded) { recipe.AddIngredient(ModCompatibility.SacredTools.Mod.Find<ModItem>("NebulaSigil"), 1); recipe.AddIngredient(ModCompatibility.SacredTools.Mod.Find<ModItem>("NubasBlessing"), 1); recipe.AddIngredient(ModCompatibility.SacredTools.Mod.Find<ModItem>("Armageddon"), 1); /*recipe.AddIngredient(ModCompatibility.SacredTools.Mod.Find<ModItem>("StoneOfResonance"), 1);*/ recipe.RemoveIngredient(ItemID.CelestialCuffs); recipe.RemoveIngredient(ItemID.SorcererEmblem); }
                    ...
                    if (ModCompatibility.Redemption.Loaded) { recipe.AddIngredient(ModCompatibility.Redemption.Mod.Find<ModItem>("Petridish"), 1); recipe.AddIngredient(ModCompatibility.Redemption.Mod.Find<ModItem>("MutagenMagic"), 1); recipe.RemoveIngredient(ItemID.SorcererEmblem); }
